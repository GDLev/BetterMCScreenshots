...
public class ScreenshotFullscreenScreen extends Screen {
    ...
    private DynamicTexture navOldTexOwned = null; // własna kopia tekstury starego obrazu

    private static final Identifier NAV_OLD_TEX_ID =
            Identifier.fromNamespaceAndPath("better_screenshots", "nav_old_screenshot");
    ...
    private void navigateTo(int direction) {
        ...
        if (useAnim) {
            // Skopiuj piksele starego obrazu do własnej tekstury,
            // bo setFullscreenTexture() nadpisze ten sam slot GPU.
            releaseOldTexOwned();
            ...
            if (current != null && current.getPixels() != null) {
                try {
                    ...
                    NativeImage copy = new NativeImage(
                            ...
                            oldPixels.getHeight(),
                            false);
                    oldPixels.copyRect(copy,
                            0, 0, 0, 0,
                            oldPixels.getWidth(), oldPixels.getHeight(),
                            false, false);
    ...
    @Override
    public void renderBackground(@NonNull GuiGraphics context,
    ...
    @Override
    public void render(@NonNull GuiGraphics context,
                       int mouseX, int mouseY, float delta) {
        ...
        if (navAnimActive) {
            ...
            int oldAlpha   = (int)((1f - easedT) * 255);
