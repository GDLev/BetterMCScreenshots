...
> Want to share screenshots even faster?
You can optionally upload directly from the game using providers like Imgur, S3, Custom HTTP/HTTPS endpoints, or Catbox.
