...
public class ScreenshotFullscreenScreen extends Screen {
    ...
    private void navigateTo(int direction) {
        ...
        if (useAnim && expectedTexture != null && expectedTexture.getPixels() != null) {
            // Capture a snapshot of current pixels into a separate texture for the animation
    ...
    private void drawActionButtons(GuiGraphics context,
        ...
        context.blit(copyHov ? ICON_COPY_H : ICON_COPY,
        ...
        context.blit(delHov ? ICON_DELETE_H : ICON_DELETE,
    ...
    public void render(GuiGraphics context,
        ...
        // Apply Z-offset to move the entire fullscreen UI forward
        ...
        if (closing && closeStart >= 0) {
            ...
            if (exitElapsed <= EXIT_DURATION_MS) {
                ...
                RenderSystem.enableBlend();
                RenderSystem.defaultBlendFunc();
                context.setColor(1.0f, 1.0f, 1.0f, imgAlpha);
                context.blit(getTexId(),
