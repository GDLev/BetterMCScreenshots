...
@EventBusSubscriber(modid = Better_screenshots.MODID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.MOD)
public class Better_screenshotsClient {
    ...
    @EventBusSubscriber(modid = Better_screenshots.MODID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.GAME)
