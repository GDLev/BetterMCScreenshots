...
public class ScreenshotPreviewRenderer {
    ...
    public static void render(GuiGraphics context) {
        ...
        ScreenshotConfig.ActionButtonCorner[] corners = {
                cfg.miniPreviewShowCorner, cfg.miniPreviewCopyCorner,
                cfg.miniPreviewUploadCorner, cfg.miniPreviewDeleteCorner
        };
        int[] order = {
                cfg.miniPreviewShowOrder, cfg.miniPreviewCopyOrder,
                cfg.miniPreviewUploadOrder, cfg.miniPreviewDeleteOrder
        };
        boolean[] visible = {
                cfg.miniPreviewShowVisible, cfg.miniPreviewCopyVisible,
