...
public class ScreenshotGalleryScreen extends Screen {
    ...
    private void openFullscreen(int idx) {
        ...
        ScreenshotPreviewRenderer.captureBackground(() -> dev.gdlev.better_screenshots.client.MinecraftCompat.setScreen(mc, screen));
    }
    ...
    private void rebuildControls() {
        ...
        backButton = Button.builder(
                        ...
                        btn -> dev.gdlev.better_screenshots.client.MinecraftCompat.setScreen(minecraft, parent))
